            ...
            <div class="box">
                <div class="comment">
                    ...
                    <div class="bcmt">
                        ...
                        <div class="bcmtadd">
                            <input on-input={this.handleChange.bind(this, 'username')} value={this.form.username} type="text" class="form-control" placeholder="请输入昵称" />
                            <textarea on-input={this.handleChange.bind(this, 'content')} id="content" class="form-control" placeholder="请输入评论内容">{this.form.content}</textarea>
                            <div class="bcmtbtn">
